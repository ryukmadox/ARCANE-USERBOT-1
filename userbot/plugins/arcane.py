...
async def amireallyalive(arcane):
   ...
   ALIVE_MESSAGE += "☯︎ 𝙶𝚁𝙾𝚄𝙿 ☯︎ : [SUPPORT](https://t.me/OP_Bot_Support)\n\n"
   ALIVE_MESSAGE += f"༄ [𝙳𝙴𝙿𝙻𝙾𝚈](https://dashboard.heroku.com/new?button-url=https%3A%2F%2Fgithub.com%2FOP120%2Heroku-Setup&template=https%3A%2F%2Fgithub.com%2FOP120%2FHeroku-Setup) ༄ 𝚈𝙾𝚄𝚁 𝙾𝚆𝙽 𝙾𝙿 ❄︎[{BOT}](https://github.com/OP120/ARCANE-USERBOT)  ❄︎\n"   
   await arcane.delete() 
